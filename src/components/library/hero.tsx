    ...
    <div className="mb-8 flex flex-col items-center gap-6 text-center">
      ...
      <div className="flex w-full justify-center">
        ...
        >
          ...
          <kbd
            aria-hidden="true"
            className="relative inline-flex h-[26px] items-center rounded-[8px] border border-pl-ink-hairline bg-white px-1.5 font-sans text-[13px] text-pl-ink-soft shadow-[0_1px_1px_rgba(0,0,0,0.04)]"
          >
            ⌘K
          </kbd>
        </button>
